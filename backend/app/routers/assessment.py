        ...
        "interpretation": [
            {
                ...
                "suggestion": "建议保持积极的生活方式，继续关注自己的心理健康。如有需要，可以随时与心屿聊天。"
            },
            {
                "range": [5, 9],
                "level": "轻度",
                "interpretation": "您可能存在轻度抑郁症状。这些症状可能会影响您的日常生活，但通过自我调节和支持可以改善。",
                "suggestion": "建议：1) 与信任的朋友或家人交流感受；2) 保持规律作息和适度运动；3) 尝试心屿的呼吸训练和情绪日记功能；4) 如果症状持续，建议咨询专业心理咨询师。"
            },
            {
                "range": [10, 14],
                "level": "中度",
                "interpretation": "您存在中度抑郁症状，这些症状可能已经对您的生活、工作或学习造成一定影响。",
                "suggestion": "强烈建议：1) 尽快预约专业心理咨询或心理治疗；2) 与家人或朋友分享您的感受；3) 使用心屿的训练功能进行辅助调节；4) 保持健康的生活方式。如需帮助，可拨打心理援助热线：400-161-9995"
            },
            {
                "range": [15, 27],
                "level": "重度",
        ...
        "interpretation": [
            {
                ...
                "suggestion": "建议保持健康的生活方式，适度运动，保证充足睡眠。如遇到压力事件，可以使用心屿的呼吸训练功能。"
            },
            {
                "range": [5, 9],
                "level": "轻度",
                "interpretation": "您存在轻度焦虑症状，这可能影响您的日常生活质量。",
                "suggestion": "建议：1) 学习放松技巧（如深呼吸、正念冥想）；2) 识别并挑战焦虑思维；3) 使用心屿的焦虑训练模块；4) 保持规律作息和适度运动；5) 如症状持续，考虑咨询心理专业人士。"
            },
            {
                "range": [10, 14],
                "level": "中度",
                "interpretation": "您存在中度焦虑症状，这已经对您的生活造成明显影响。",
                "suggestion": "强烈建议：1) 寻求专业心理咨询或治疗；2) 学习并实践放松技术；3) 减少咖啡因摄入；4) 使用心屿的训练功能辅助调节；5) 与信任的人分享感受。心理援助热线：400-161-9995"
            },
            {
                "range": [15, 21],
                "level": "重度",
        ...
        "interpretation": [
            {
                ...
                "suggestion": "建议继续保持健康的生活方式，适时放松和娱乐。如遇到新的压力源，可以使用心屿的压力管理工具。"
            },
            {
                "range": [14, 26],
                "level": "中等压力",
                "interpretation": "您目前承受着中等程度的压力，这是较为常见的状态。",
                "suggestion": "建议：1) 识别主要压力源；2) 学习时间管理技巧；3) 实践放松技术（如深呼吸、正念）；4) 保持社交联系；5) 确保充足睡眠和规律运动；6) 使用心屿的压力缓解训练。"
            },
            {
                "range": [27, 40],
                "level": "高压力",
                "interpretation": "您目前承受着较高水平的压力，这可能影响您的身心健康。",
                "suggestion": "强烈建议：1) 评估并减少可避免的压力源；2) 寻求专业心理咨询；3) 学习有效的应对策略；4) 加强社会支持系统；5) 注意身体健康信号；6) 使用心屿的综合训练计划。如需帮助：心理援助热线 400-161-9995"
            }
        ]
    },
    ...
    # ISI 失眠严重程度指数
    {
        ...
        "interpretation": [
            ...
            },
            {
                ...
                "suggestion": "建议：1) 建立规律的睡眠作息；2) 睡前1小时放松活动（如阅读、听音乐）；3) 避免咖啡因和酒精；4) 使用心屿的睡眠冥想训练；5) 记录睡眠日记了解睡眠模式。"
            },
            {
                "range": [15, 21],
                "level": "中度失眠",
                "interpretation": "您存在中度失眠症状，已经明显影响您的睡眠质量和日常功能。",
                "suggestion": "强烈建议：1) 咨询睡眠专科医生或心理治疗师；2) 学习认知行为疗法（CBT-I）技巧；3) 排查可能的医学原因；4) 使用心屿的睡眠改善训练计划；5) 避免白天小睡；6) 建立放松的睡前仪式。"
            },
            {
                "range": [22, 28],
                "level": "重度失眠",
        ...
        "interpretation": [
            {
                ...
                "suggestion": "建议：1) 学习积极应对策略；2) 培养成长型思维模式；3) 建立支持性社交网络；4) 设定小而可实现的目标增强信心；5) 使用心屿的心理韧性训练模块；6) 考虑寻求心理咨询帮助提升应对能力。记住，心理韧性是可以培养的！"
            },
            {
                "range": [21, 30],
                "level": "心理韧性中等",
                "interpretation": "您具备一定的心理韧性，能够应对大多数压力情境，但仍有提升空间。",
                "suggestion": "建议：1) 继续发展积极应对策略；2) 从过往克服困难的经历中汲取力量；3) 保持乐观但现实的态度；4) 定期反思和总结应对经验；5) 使用心屿的进阶训练提升韧性；6) 在遇到重大挑战时主动寻求支持。"
            },
            {
                "range": [31, 40],
                "level": "心理韧性较高",
                "interpretation": "您具有很强的心理韧性，能够有效应对压力、从挫折中快速恢复，并在逆境中成长。",
                "suggestion": "优秀！继续保持：1) 将您的应对经验分享给他人；2) 在新的挑战中继续磨练韧性；3) 帮助他人提升心理韧性；4) 保持自我觉察，注意身心平衡；5) 使用心屿记录和反思成长历程。您的韧性是宝贵的心理资源！"
            }
        ]
    },
    ...
    # LSAS 社交焦虑量表（简版）
    {
        ...
        "interpretation": [
            ...
            },
            {
                ...
                "suggestion": "建议：1) 识别让您焦虑的具体社交情境；2) 采用渐进式暴露法逐步适应；3) 练习社交技巧和沟通方法；4) 使用心屿的社交焦虑训练；5) 挑战负面的自我评价；6) 庆祝每一次社交成功。"
            },
            {
                "range": [19, 27],
                "level": "中度社交焦虑",
                "interpretation": "您在社交情境中经常感到焦虑，并可能因此回避某些社交活动，影响生活质量。",
                "suggestion": "强烈建议：1) 寻求专业心理咨询或认知行为疗法（CBT）；2) 学习放松技巧应对焦虑；3) 加入社交技能训练小组；4) 使用心屿的系统化训练计划；5) 挑战消极思维模式；6) 设定渐进式社交目标。心理援助热线：400-161-9995"
            },
            {
                "range": [28, 36],
                "level": "重度社交焦虑",
